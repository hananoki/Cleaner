...
namespace Cleaner {
	partial class UI_MainWindow {
		...
		private void InitializeComponent() {
			...
			toolStrip1.Size = new Size( 530, 42 );
			...
			toolStripButton1.Size = new Size( 53, 35 );
			toolStripButton1.Text = "クリーナー";
